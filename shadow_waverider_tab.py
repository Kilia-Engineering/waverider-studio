...
class ShadowWaveriderTab(QWidget):
    ...
    def _create_export_group(self):
        ...
        layout.addWidget(QLabel("Gmsh min:"), 2, 0)
        self.gmsh_min = QDoubleSpinBox()
        self.gmsh_min.setRange(0.0001, 1); self.gmsh_min.setValue(0.01); self.gmsh_min.setDecimals(4)
        layout.addWidget(self.gmsh_min, 2, 1)
        
        layout.addWidget(QLabel("Gmsh max:"), 3, 0)
        self.gmsh_max = QDoubleSpinBox()
        self.gmsh_max.setRange(0.001, 1); self.gmsh_max.setValue(0.05); self.gmsh_max.setDecimals(4)
